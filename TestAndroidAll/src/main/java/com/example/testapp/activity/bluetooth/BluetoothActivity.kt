package com.example.testapp.activity.bluetooth

import android.bluetooth.BluetoothDevice
import android.bluetooth.BluetoothGatt
import android.bluetooth.BluetoothGattCharacteristic
import android.bluetooth.BluetoothGattDescriptor
import android.lorenwang.bluetooth.BluetoothOptionsUtils
...
class BluetoothActivity : BaseActivity() {
    ...
    override fun initListener(savedInstanceState: Bundle?) {
        ...
        //蓝牙操作回调
        BluetoothOptionsUtils.getInstance(this).setBluetoothOptionsCallback(object : BluetoothOptionsCallback {
