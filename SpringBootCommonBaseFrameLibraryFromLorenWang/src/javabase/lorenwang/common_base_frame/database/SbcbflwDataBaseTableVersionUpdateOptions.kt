...
abstract class SbcbflwDataBaseTableVersionUpdateOptions {
    ...
    fun initData(applicationContext: ConfigurableApplicationContext) {
        ...
        try {
            ...
            //获取数据库表版本表操作实例
            databaseTableVersionRepository = applicationContext.getBean(SbcbflwDatabaseTableVersionRepository::class.java)
            ...
            if (tableVersion == null) {
                ...
                //保存版本信息
                val databaseTableVersionTb = SbcbflwBaseDatabaseTableVersionTb()
