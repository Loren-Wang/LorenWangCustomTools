 ...
 * @author 王亮（Loren）
 */
public class AvlwVideoListPlayItemView extends AvlwVideoPlayView {
    private final String TAG = "AvlwVideoListPlayItemView:";

    public AvlwVideoListPlayItemView(Context context) {
        super(context);
        init(context, null, -1);
    }

    public AvlwVideoListPlayItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, -1);
    }

    public AvlwVideoListPlayItemView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//     */
//    public void setPlayCallback(AvlwVideoPlayView.PlayCallback playCallback) {
