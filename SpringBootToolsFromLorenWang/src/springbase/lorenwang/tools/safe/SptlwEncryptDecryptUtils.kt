 ...
 * 备注：
 */
open class SptlwEncryptDecryptUtils private constructor() {
    companion object {
        private var optionsUtils: SptlwEncryptDecryptUtils? = null

        @JvmStatic
        val instance: SptlwEncryptDecryptUtils
            get() {
                if (optionsUtils == null) {
                    synchronized(this::class.java) {
                        if (optionsUtils == null) {
                            optionsUtils = SptlwEncryptDecryptUtils()
                        }
                    }
                }
                return optionsUtils!!
