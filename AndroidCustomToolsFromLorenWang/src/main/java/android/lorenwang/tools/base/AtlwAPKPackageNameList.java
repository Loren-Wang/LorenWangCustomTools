 ...
 * 思路：
 * 方法：
 * 应用宝--MARKET_APPLICATION_OF_TREASURE
 * 魅族应用商店--MARKET_FLY_ME
 * 华为应用商店--MARKET_HUA_WEI
 * 酷派应用商店--MARKET_COOLPAD
 * oppo应用商店--MARKET_OPPO
 * vivo应用商店--MARKET_VIVO
 * 三星应用商店--MARKET_SAMSUNG
 * 小米应用商店--MARKET_XIAO_MI
 * 百度手机助手--MARKET_BAIDU
 * 百度地图--MAP_BAIDU
 * 腾讯地图--MAP_TENCENT
 * 高德地图--MAP_GAODE
 ...
 * 备注：
 */
public class AtlwAPKPackageNameList {
    /**
     * 应用宝
     */
