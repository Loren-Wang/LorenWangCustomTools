 ...
 * @author 王亮（Loren）
 */
public class AtlwSpannableTagBean extends ReplacementSpan {
    /**
     * 要改变颜色的数据
     */
     ...
     */
    public AtlwSpannableTagBean(String paramsMsg, int bgColor, int textColor, int borderColor, int borderWidth, Float tagRadio, Float textSize) {
