...
public class AtlwImageLoadConfig {
     ...
     * 回调
     */
    private AtlwImageLoadBitmapCallback callback;
    ...
    public AtlwImageLoadBitmapCallback getCallback() {
        return callback;
    }
    ...
    public static class Build {
        ...
        public Build setCallback(AtlwImageLoadBitmapCallback callback) {
