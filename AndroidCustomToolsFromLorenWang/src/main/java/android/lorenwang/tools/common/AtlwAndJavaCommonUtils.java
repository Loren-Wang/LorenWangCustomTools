...
public class AtlwAndJavaCommonUtils {
    private final String TAG = "CommonUtils";
    private static AtlwAndJavaCommonUtils baseUtils;

    private AtlwAndJavaCommonUtils() {
    }

    public static AtlwAndJavaCommonUtils getInstance() {
        if (baseUtils == null) {
            baseUtils = new AtlwAndJavaCommonUtils();
        }
        return (AtlwAndJavaCommonUtils) baseUtils;
    }
