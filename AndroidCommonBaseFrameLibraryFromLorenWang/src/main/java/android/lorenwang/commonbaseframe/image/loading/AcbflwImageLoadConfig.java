...
public class AcbflwImageLoadConfig {
     ...
     * 图片加载回调
     */
    private AcbflwImageLoadCallback loadCallback;
    /**
     * 缩放类型
     */
    ...
    public AcbflwImageLoadCallback getLoadCallback() {
        return loadCallback;
    }
    ...
    public static class Build {
        ...
        public Build setLoadCallback(AcbflwImageLoadCallback loadCallback) {
