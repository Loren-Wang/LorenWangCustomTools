...
class AcbflwSinaShare {
    ...
    public void shareText(AcbflwShareDataBean shareDataBean) {
       if(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA) != null){
           ...
           if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaText())) {
               //回调异常
           ...
           AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA).getSinaApi(shareDataBean.getActivity()).shareMessage(message, false);
           AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.DEFAULT).addCallBack(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA).sinaKey(shareDataBean.getActivity()),
    ...
    public void shareImageBitmap(AcbflwShareDataBean shareDataBean) {
       if(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA) != null){
           ...
           if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaImageViewBitmap())) {
               //回调异常
    ...
    public void shareWeb(AcbflwShareDataBean shareDataBean) {
        if(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA) != null) {
            ...
            if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaTitle())) {
                //回调异常
                callBackError(shareDataBean, AcbflwPluginErrorTypeEnum.SHARE_TITLE_EMPTY);
                return;
            }
            if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaDes())) {
                //回调异常
            ...
            if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaWebUrl())) {
                //回调异常
            ...
            try {
                webObject.thumbData = AtlwImageCommonUtil.getInstance().bitmapCompressToByte(shareDataBean.getSinaImageViewBitmap(), Bitmap.CompressFormat.JPEG, 1024 * 1024);
            } catch (Exception e) {
                e.printStackTrace();
            }
            webObject.actionUrl = shareDataBean.getSinaWebUrl();
            webObject.defaultText = JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaText()) ? "" : shareDataBean.getSinaText();
            message.mediaObject = webObject;
            AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA).getSinaApi(shareDataBean.getActivity()).shareMessage(message, false);
            AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.DEFAULT).addCallBack(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA).sinaKey(shareDataBean.getActivity()), shareDataBean.getShareCallBack());
        }
    }
    ...
    public void shareVideo(AcbflwShareDataBean shareDataBean) {
        if(AcbflwPluginUtil.getInstance(AcbflwPluginTypeEnum.SINA) != null) {
            ...
            if (JtlwCheckVariateUtil.getInstance().isEmpty(shareDataBean.getSinaVideoPath())) {
                //回调异常
